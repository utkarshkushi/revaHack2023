                ...
                <div className="links flex gap-10 justify-center items-center">
                    ...
                    {session?.user ? (
                        <>
                            ...
                            <a href={`http://localhost:3000/wallet?email=${session?.user.email}`} className="link font-manrope text-lg px-10 py-2 border-2 border-white rounded-3xl hover:text-[#F1CEFA] hover:border-[#F1CEFA] hover:scale-90 transition-all ">Make Transaction</a>
                        </>
